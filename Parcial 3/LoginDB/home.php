...
<nav class="navbar navbar-expand-lg navbar-light navbar-dark fixed-top" style="background-color: #563d7c !important;">
    ...
    <div class="my-2 my-lg-0" id="maquinaescribir">
      <h5 class="navbar-brand">Clientes Jesus<span>&#160;</span></h5>
    </div>
</nav>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <td> 
                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteClients<?php echo $dataCliente['id']; ?>">
                                  Eliminar
                              </button>
                            
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editClients<?php echo $dataCliente['id']; ?>">
                                  Modificar
                              </button>
                          </td>
                          </tr>
